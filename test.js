...
function DebtorDetail() {
  ...
  const [quantities, setQuantities] = useState({}); // Will store quantities for each inventory item
    ...
    <>
      ...
      <div>
        <div className={styles.container}>
          ...
          {/* Option to pay debt */}
          <button onClick={handlePayDebt} className={styles.button}>
            Pay Debt
          </button>
